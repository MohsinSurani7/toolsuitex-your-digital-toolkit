...
const MetaTagGenerator = () => {
  ...
  const seoContent = {
    ...
    aboutTool: "Our Meta Tag Generator creates all the meta tags your website needs for SEO and social sharing. Perfect for web developers and content creators."
  };
